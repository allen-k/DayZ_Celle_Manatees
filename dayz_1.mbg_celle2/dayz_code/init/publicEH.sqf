...
if (!isDedicated) then {
	...
	"silversHalo" addPublicVariableEventHandler {(_this select 1) spawn silver_Halo};
	"silversSpawnLight" addPublicVariableEventHandler {(_this select 1) spawn silver_spawnLight};
	"silversSpawnSmoke" addPublicVariableEventHandler {(_this select 1) spawn silver_spawnSmoke};
	"silversExercise" addPublicVariableEventHandler {(_this select 1) spawn silver_Exercise};
};