...
hotkey_hitme = 0; // Sets the ON OFF state to (OFF) for the debug monitor hotkey

"filmic" setToneMappingParams [0.07, 0.31, 0.23, 0.37, 0.011, 3.750, 6, 4]; setToneMapping "Filmic";

// Manatee Mission file compiles
fnc_usec_selfActions = compile preprocessFileLineNumbers "dayz_code\compile\fn_selfActions.sqf";	
player_packTent = compile preprocessFileLineNumbers "manatee\playerpacktent\player_packTent.sqf";
...
player_temp_calculation	= compile preprocessFileLineNumbers "dayz_code\compile\fn_temperatur.sqf";
...
player_setTrap = compile preprocessFileLineNumbers "fixes\player_setTrap.sqf";
player_sleep = compile preprocessFileLineNumbers "manatee\sleep\sleep.sqf";
player_knockout = compile preprocessFileLineNumbers "manatee\melee\knockout2.sqf";
player_frisk = compile preprocessFileLineNumbers "manatee\melee\frisk.sqf";
...
player_humanityChange =	compile preprocessFileLineNumbers "fixes\player_humanityChange.sqf";
player_spawnZedCheck = compile preprocessFileLineNumbers "fixes\player_spawnzedCheck.sqf";
building_spawnLoot = compile preprocessFileLineNumbers "fixes\building_spawnLoot.sqf";
player_selfBloodbag = compile preprocessFileLineNumbers "manatee\selfbb\bloodbag.sqf";
player_death = compile preprocessFileLineNumbers "fixes\player_death.sqf";
player_studyBody = compile preprocessFileLineNumbers "manatee\studybody\study_body.sqf";
player_makeFire = compile preprocessFileLineNumbers "fixes\player_makefire.sqf";
playerstats = compile preprocessFileLineNumbers "manatee\debug\playerdebug.sqf";
silver_Halo = compile preprocessFileLineNumbers "manatee\halo\halo_anm.sqf";
silver_spawnLight = compile preprocessFileLineNumbers "manatee\jip\spawn_light.sqf";
silver_spawnSmoke = compile preprocessFileLineNumbers "manatee\jip\spawn_smoke.sqf";
silver_Exercise = compile preprocessFileLineNumbers "manatee\exercise\exercising.sqf";
playerstats = compile preprocessFileLineNumbers "manatee\debug\playerdebug.sqf";
player_spawnCheck = compile preprocessFileLineNumbers "fixes\player_spawnCheck.sqf";
player_spawnLootCheck =	compile preprocessFileLineNumbers "fixes\player_spawnlootCheck.sqf";
...
object_pickup = compile preprocessFileLineNumbers "fixes\object_pickup.sqf";
...
wild_spawnZombies = compile preprocessFileLineNumbers "fixes\wild_spawnZombies.sqf";
//player_lightFire = compile preprocessFileLineNumbers "manatee\fixes\fire_light.sqf";
// Manatee Server file compiles
...
[] spawn {
	...
	dayz_spaceInterrupt = {
		...
		{
			_nill = execvm "manatee\debug\playerdebug.sqf";
		};
