	...
	if (!isNull _source) then {
		if (_source != player) then {
			...
			if (!_isBandit) then {
				...
				_ph = player getVariable ["humanity",0];
				_humanity = 0;
				if (_ph >= 0 and _ph < 5000) then {
					_humanity = -200;
				};
				if (_ph >= 5000 and _ph < 10000) then {
					_humanity = -300;
				};
				if (_ph >= 10000 and _ph < 15000) then {
					_humanity = -400;
				};
				if (_ph >= 15000 and _ph < 20000) then {
					_humanity = -500;
				};
				if (_ph >= 20000) then {
					_humanity = -750;
				...
				if (_ph < -15000 and _ph >= -25000) then {
					_humanity = 500;
				};
				if (_ph < -25000) then {
					_humanity = 750;
